...
CREATE TRIGGER decrease_profile_followings_acount AFTER INSERT ON TB_PROFILE_FOLLOWING FOR EACH ROW EXECUTE PROCEDURE decrease_profile_followings_acount();